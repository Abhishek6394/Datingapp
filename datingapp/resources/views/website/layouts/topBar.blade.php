		...
		<div class="header__bottom">
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					<a class="navbar-brand" href="/"><img src="{{ URL::to('public/website/assets/images/logo/logo.png') }}" alt="logo"></a>
					...
					<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
						...
						<ul class="button-group">
							...
							<li><a href="{{ url('logout') }}" class="default-btn login"><i class="fa-solid fa-user"></i> <span>LOG OUT</span> </a></li>
                             @else
							<li><a href="{{ url('login') }}" class="default-btn login"><i class="fa-solid fa-user"></i> <span>LOG IN</span> </a></li>
							<li><a href="{{ url('register') }}" class="default-btn signup"><i class="fa-solid fa-users"></i> <span>SIGN UP</span> </a></li>
							<li><a href="{{ url('seller') }}" class="default-btn login"><i class="fa-solid fa-users"></i> <span>Create Profile</span> </a></li>
							@endif
						</ul>
					</div>
				</nav>
