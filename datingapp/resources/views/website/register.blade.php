                          ...
                          <!--   @if ($message = Session::get('success'))
                            ...
                            <form action="{{route('save.register')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="my-form-control" name="password" value="{{old('password')}}" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter Your Password">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="my-form-control" value="{{old('confirmpassword')}}" name="confirmpassword" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter Your Password">
                                ...
                                <div class="form-group">
                                    <label>Name*</label>
                                    <input type="text" class="my-form-control" name="name" value="{{old('name')}}" placeholder="Enter Your Full Name">
                                     @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="banner__inputlist">
                                        <div class="s-input me-3">
                                            <input type="radio" name="lookingfor" id="males" value="men" @if(old('lookingfor')=="men") checked @endif>

                                             <label
                                                for="males" >Man</label>
                                        </div>
                                        <div class="s-input">
                                            <input type="radio" name="lookingfor" value="women" id="females" @if(old('lookingfor')=="women") checked @endif>
                                            <label
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="banner__inputlist">
                                        <select name="matrital_status">
                                            <option value="Single" @if(old('matrital_status')=="Single") selected @endif>Single</option>
                                            <option value="Marid" @if(old('matrital_status')=="Marid") selected @endif>Married</option>
                                        </select>
=======
                                @if ($errors->has('gender'))
                                    <p class="text-danger">{{ $errors->first('gender') }}</p>
...
<<<<<<< HEAD
                                ...
                                <div class="form-group">
                                    <label>City*</label>
                                    <input type="text" name="city" class="my-form-control" value="{{old('city')}}" placeholder="Enter Your City">
                                     @if($errors->has('city'))
