...
@section('title', 'Wecome to Ollay')
	...
	<div class="banner banner--style3 padding-top bg_img" style="background-image: url({{ URL::to('public/website/assets/images/banner/bg-3.jpg') }});">
		<div class="container">
				...
				<div class="col-lg-6 col-12 wow fadeInUp" data-wow-duration="1.5s">
					<div class="banner__thumb text-xl-end">
						...
						<div class="banner__thumb--shape">
							<div class="shapeimg">
								<img src="{{ URL::to('public/website/assets/images/banner/shape/home3/01.png') }}" alt="dating thumb">
							</div>
						</div>
